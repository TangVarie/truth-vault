...
> ✅ **2026-09-20 · 生产已 apply 到 v1_13**(编号 13 落仓晚于 14 / 15, 不改; 见 D-070 续): `note_feature_answers` / `feature_validation` / `content_scores` 三张空表 + `v_feature_contrast` 就位, `v_l2_labels` 未动(正例 304 / 负例 4,652)。等 Railway worker 重新部署后 daily-sync 开始每晚增量。
