...
1. 书架**预策展只摆高分级(爆/大爆/参考)且排除 synthetic 伪贴**——D-002 的"长尾 160/170 趴、检索捞到趴"前提在此不成立（趴 + 造假指标的都不进库）。(参考随 docs/13 进库、rank 最低;synthetic 无差别排除,见 §4.1。)
