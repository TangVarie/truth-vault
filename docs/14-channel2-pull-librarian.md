...
1. 书架**预策展只摆高分级(爆/大爆/参考)**——D-002 的"长尾 160/170 趴、检索捞到趴"前提在此不成立（趴不进库）。(参考随 docs/13 进库、rank 最低;**synthetic 伪贴只挡爆/大爆,参考放行**——参考是人工内容判断、与指标真假无关,带 synthetic 标记,见 §4.1 / Session #15。)
